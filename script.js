    ...
    try {
        const response = await fetch(url, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: "You are a witty, magical anti-procrastination coach for Aisha. Your style is inspired by 'Once Upon a Broken Heart'—a bit whimsical, firm but encouraging. Help her break tasks into steps. User says: " + userInput
                    }]
                }]
            })
        });
